...
def demonstrate_stock_alerts():
    ...
    print(f"Product 1: {product1.name} (Stock: {product1.quantity}, Reorder Level: {product1.reorder_level})")
    ...
    print(f"Product 2: {product2.name} (Stock: {product2.quantity}, Reorder Level: {product2.reorder_level})")
    ...
    product2.quantity = new_quantity
    product2.save()
    print(f"Abnormal sale: Sold {abnormal_quantity} units. New stock: {product2.quantity}")
