...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('filename', type=str, help='CSV file name in uploads directory')
        parser.add_argument('--business-id', type=int, help='Business ID to associate products with')
        parser.add_argument('--user-id', type=int, help='User ID to associate with the upload (optional)')
                ...
                for row_num, row in enumerate(reader, start=2):
                    try:
                        ...
                        try:
                            ...
                            reorder_level = float(reorder_level) if reorder_level else 0.0
