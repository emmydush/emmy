...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--backend",
            type=str,
            choices=["smtp", "console", "ses"],
            default="smtp",
            help="Email backend",
        )
        parser.add_argument(
            "--host", type=str, help="Email host (e.g., smtp.gmail.com)"
        )
        parser.add_argument(
            "--port", type=int, default=587, help="Email port (default: 587)"
        )
        parser.add_argument("--username", type=str, help="Email username")
        parser.add_argument(
            "--password", type=str, help="Email password or app password"
        )
