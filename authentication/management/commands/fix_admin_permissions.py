...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('username', type=str, help='Username of the admin user to fix permissions for')
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if not user.owned_businesses.exists():
                ...
                self.stdout.write(self.style.SUCCESS(f'Created business: {business.company_name}'))
            else:
            ...
            self.stdout.write(self.style.SUCCESS(f'Successfully fixed permissions for user: {username}'))
