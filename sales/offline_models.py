...
class OfflineSale(models.Model):
    ...
    business = models.ForeignKey(
        Business, on_delete=models.CASCADE, related_name="offline_sales"
    )
    ...
    status = models.CharField(
        max_length=10, choices=SALE_STATUS_CHOICES, default="pending"
    )
...
class OfflineSettings(models.Model):
    ...
    business = models.OneToOneField(
        Business, on_delete=models.CASCADE, related_name="offline_settings"
    )
